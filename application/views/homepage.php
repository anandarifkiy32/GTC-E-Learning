...
<head>
	...
	<!-- Bootstrap -->
	<link type="text/css" rel="stylesheet" href="<?php echo base_url() ?>assets/client/css/bootstrap.min.css"/>

	<!-- Font Awesome Icon -->
	<link rel="stylesheet" href="<?php echo base_url() ?>assets/client/css/font-awesome.min.css">

	<!-- Custom stlylesheet -->
	<link type="text/css" rel="stylesheet" href="<?php echo base_url() ?>assets/client/css/style.css"/>
	...
	<body>
				...
				<div class="navbar-header">
					...
					<div class="navbar-brand">
						<a class="logo" href="index.html">
							<img src="<?php echo base_url() ?>assets/client/img/logo-alt.png" alt="logo">
						</a>
					</div>
					<!-- /Logo -->
		...
		<div id="about" class="section">
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="about-img">
							<img src="<?php echo base_url() ?>assets/client/img/about.png" alt="">
						</div>
					</div>
				...
				<div id="courses-wrapper">
					...
					<div class="row">
						...
						<div class="col-md-3 col-sm-6 col-xs-6">
							<div class="course">
								<a href="#" class="course-img">
									<img src="<?php echo base_url() ?>assets/client/img/course01.jpg" alt="">
						...
						<div class="col-md-3 col-sm-6 col-xs-6">
							<div class="course">
								<a href="#" class="course-img">
									<img src="<?php echo base_url() ?>assets/client/img/course02.jpg" alt="">
									<i class="course-link-icon fa fa-link"></i>
								</a>
						...
						<div class="col-md-3 col-sm-6 col-xs-6">
							<div class="course">
								<a href="#" class="course-img">
									<img src="<?php echo base_url() ?>assets/client/img/course03.jpg" alt="">
									<i class="course-link-icon fa fa-link"></i>
								</a>
						...
						<div class="col-md-3 col-sm-6 col-xs-6">
							<div class="course">
								<a href="#" class="course-img">
									<img src="<?php echo base_url() ?>assets/client/img/course04.jpg" alt="">
									<i class="course-link-icon fa fa-link"></i>
								</a>
					...
					<div class="row">
						...
						<div class="col-md-3 col-sm-6 col-xs-6">
							<div class="course">
								<a href="#" class="course-img">
									<img src="<?php echo base_url() ?>assets/client/img/course05.jpg" alt="">
									<i class="course-link-icon fa fa-link"></i>
								</a>
						...
						<div class="col-md-3 col-sm-6 col-xs-6">
							<div class="course">
								<a href="#" class="course-img">
									<img src="<?php echo base_url() ?>assets/client/img/course06.jpg" alt="">
									<i class="course-link-icon fa fa-link"></i>
								</a>
						...
						<div class="col-md-3 col-sm-6 col-xs-6">
							<div class="course">
								<a href="#" class="course-img">
									<img src="<?php echo base_url() ?>assets/client/img/course07.jpg" alt="">
									<i class="course-link-icon fa fa-link"></i>
								</a>
						...
						<div class="col-md-3 col-sm-6 col-xs-6">
							<div class="course">
								<a href="#" class="course-img">
									<img src="<?php echo base_url() ?>assets/client/img/course08.jpg" alt="">
									<i class="course-link-icon fa fa-link"></i>
								</a>
				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="footer-logo">
							<a class="logo" href="index.html">
								<img src="<?php echo base_url() ?>assets/client/img/logo.png" alt="logo">
							</a>
						</div>
					</div>
					<!-- footer logo -->
		...
		<script type="text/javascript" src="<?php echo base_url() ?>assets/client/js/bootstrap.min.js"></script>
