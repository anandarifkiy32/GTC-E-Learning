        ...
        <?php foreach ($materi as $m) { ?>
          <div class="box" style="border-top:none;">
            ...
            <div class="col-md-4" style="padding-top: 10px">
              ...
              <?php if ($m->ppt != '') { 
                echo '';} else{ ?>
                  <button class="btn btn-primary btn-flat" data-toggle="modal" data-target="#modal-default8"><span class="fa fa-plus"></span> Materi</button>
                  <?php }
                  if ($m->pdf != '') { 
                    echo '';} else{ ?>
                      <button class="btn btn-primary btn-flat" data-toggle="modal" data-target="#modal-default2"><span class="fa fa-plus"></span> Handout</button>
                      <?php }
                      if ($m->konten != '') { 
                        echo '';} else{ ?>
                          <button class="btn btn-primary btn-flat" data-toggle="modal" data-target="#modal-default3"><span class="fa fa-plus"></span> Video</button>
                          <?php }
                          ?>
                          <button class="btn btn-success btn-flat" data-toggle="modal" data-target="#modal-default1">Edit Materi</button>
                        </div>
                        </div>
                        </div>
