<div class="content-wrapper">
  <section class="content-header">
    <a href="<?php echo base_url('trainer/detailmateri/'.$this->uri->segment(3)) ?>"><button type="button" class="btn btn-flat btn-success"><span class="fa fa-arrow-left"></span> Back</button></a>
