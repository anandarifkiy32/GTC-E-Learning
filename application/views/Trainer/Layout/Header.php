...
<!-- Logo -->
<a href="<?php echo base_url('trainer') ?>" class="logo">
...
<img src="<?php echo base_url('assets/profile_photos/trainer/'.$foto) ?>" class="user-image" alt="User Image">
<span class="hidden-xs"><?php echo $this->session->userdata("nama");?></span>
</a>
<ul class="dropdown-menu">
<!-- User image -->
<li class="user-header">
<img src="<?php echo base_url('assets/profile_photos/trainer/'.$foto) ?>" class="img-circle" alt="User Image">
