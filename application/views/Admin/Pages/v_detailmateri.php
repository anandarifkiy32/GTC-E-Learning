                              ...
                              if ($m->ppt != '') {?>
                                <tr>
                                  ...
                                  <td>
                                    ...
                                    <a href="<?php echo base_url().'admin/hapusppt/'.$m->slug?>"><button class="btn btn-danger btn-flat btn-xs"><span class="fa fa-trash"></span></button></a>
                                  </td>
                                </tr>
                              <?php }else{
                                echo "";
                                ...
                                <tr>
                                  ...
                                  <td>
                                   <!--  <button class="btn btn-primary btn-flat btn-xs" data-toggle="modal" data-target="#modal-default4">Edit</button> -->
                                    <a href="<?php echo base_url().'admin/hapuspdf/'.$m->slug?>"><button class="btn btn-danger btn-flat btn-xs"><span class="fa fa-trash"></span></button></a>
                                  </td>
                                </tr>
                              <?php }else{
                                echo "";
                              ...
                              if($m->konten != ''){?>
                                <tr>
                                  ...
                                  <td>
                                    ...
                                    <a href="<?php echo base_url().'admin/hapuskonten/'.$m->slug ?>"><button class="btn btn-danger btn-flat btn-xs"><span class="fa fa-trash"></span></button></a>
                                  </td>
                                </tr>
                              <?php }else{
                                echo "";
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        <div class="modal-header">
                          ...
                          <form role="form" action="<?php echo base_url().'admin/tambahpdf' ?>" method="post"  enctype="multipart/form-data">
                            <div class="modal-body">
                              <div class="box-body">
                                <div class="form-group">
                                  <input type="hidden" name="id" value="<?php echo $m->id_materi ?>">
                      ...
                      <div class="modal-dialog">
                        <div class="modal-content">
                          <div class="modal-header">
                            ...
                            <form role="form" action="<?php echo base_url().'admin/tambahkonten' ?>" method="post">
                              <div class="modal-body">
                                <div class="box-body">
                                  <div class="form-group">
                                    <input type="hidden" name="id" value="<?php echo $m->id_materi ?>">
                        ...
                        <div class="modal-dialog">
                          <div class="modal-content">
                            <div class="modal-header">
                              ...
                              <form role="form" action="<?php echo base_url().'admin/updatepdf' ?>" method="post" enctype="multipart/form-data">
                                <div class="modal-body">
                                  <div class="box-body">
                                    <div class="form-group">
                                      <input type="hidden" name="id" value="<?php echo $m->id_materi ?>">
                          ...
                          <div class="col-md-12">
                            <div class="box" style="border-top:none">
                              <div class="box-header">
                                ...
                                <!-- <a href="<?php echo base_url('admin/tambahquiz/'.$m->slug) ?>"><button class="btn btn-primary btn-flat" style="float: right; margin-left: 10px;"><span class="fa fa-plus"></span> Quiz</button></a>  <?php if ($cekquiz < 1) { ?>
                              <?php } else{ ?>
                                <a href="<?php echo base_url('admin/hapusquiz/'.$m->slug) ?>"><button class="btn btn-danger btn-flat" style="float: right; margin-left: 3px;">Delete Quiz</button></a>
                                <a href="<?php echo base_url('admin/editquiz/'.$m->slug) ?>"><button class="btn btn-primary btn-flat" style="float: right; margin-left: 3px;">Edit Detail Quiz</button></a>
                                <a href="<?php echo base_url('admin/tambahsoal2/'.$m->slug) ?>"><button class="btn btn-default btn-flat" style="float: right; margin-left: 3px;">Tambah Soal</button></a>
                              <?php }
                              ?> -->
                            </div>
                            <div class="box-body">
                                ...
                                <tbody>
                                  <?php $num = 1 ;foreach ($quiz as $q) { ?>
                                    <tr>
                                      ...
                                      <td>
                                        <a href="<?php echo base_url('admin/show_quiz/'.$this->uri->segment(3).'/'.$q->code) ?>"><button type="button" class="btn btn-primary btn-xs btn-flat">Lihat</button></a>
                                        <a href="<?php echo base_url('admin/hapusquiz/'.$this->uri->segment(3).'/'.$q->code) ?>"><button type="button" class="btn btn-danger btn-xs btn-flat">Hapus</button></a>
                                      </td>
                                    </tr>
                                    <?php $num++; } ?>
                                  </tbody>
