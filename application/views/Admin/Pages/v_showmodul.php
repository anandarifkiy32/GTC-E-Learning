        ...
        <div class="box" style="border-top:none;">
          ...
          <div class="box-body">
            <table class="table table-condensed">
              ...
              <td align="right">
                <a href="<?php echo base_url().'admin/show_materi/'.$s->slug ?>"><button class="btn btn-primary btn-flat btn-xs">Lihat</button></a>
                <a href="<?php echo base_url().'admin/delete_materi/'.$s->slug.'/'.$this->uri->segment(3) ?>"><button class="btn btn-danger btn-flat btn-xs"><span class="fa fa-trash"></span></button></a>
              </td>
            </tbody>
            <?php $no++; } ?>
          </table>
    ...
    <div class="col-md-12">
      <div class="box" style="border-top:none">
        <div class="box-header">
          ...
          <?php if ($cek == 1) { ?>
            <a href="<?php echo base_url('admin/hapussertifikasi/'.$this->uri->segment(3)) ?>"><button type="button" class="btn btn-flat btn-danger" style="float: right;"><span class="fa fa-trash"></span></button></a>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <form role="form" action="<?php echo base_url().'admin/update_picturecourse' ?>" method="post" enctype="multipart/form-data">
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <form role="form" action="<?php echo base_url().'admin/tambahmateri/'.$this->uri->segment(3) ?>" method="post">
                <div class="modal-body">
                  <div class="box-body">
                    <div class="form-group">
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <form role="form" action="<?php echo base_url().'admin/tambahsertifikasi/'.$this->uri->segment(3) ?>" method="post">
                  <div class="modal-body">
                    <div class="box-body">
                      <div class="form-group">
                        <?php foreach ($modul as $m) { ?>
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  ...
                  <form role="form" action="<?php echo base_url().'admin/updatesertifikasi/'.$this->uri->segment(3) ?>" method="post">
                    <div class="modal-body">
                      <div class="box-body">
                        <div class="form-group">
                          <?php foreach ($sertifikasi as $st) { ?>
