				...
				<div class="row">
					...
					<div class="col-md-5 col-md-offset-1">
						...
						<ul class="contact-details">
							...
							<li><i class="fa fa-map-marker"></i>Permata Indo Niaga - Head Office <p style="    margin: 8px 55px 10px;"> Jalan Cidodol Raya No 40, Kenayoran Lama, Jakarta Selatan</p></li>
						</ul>
