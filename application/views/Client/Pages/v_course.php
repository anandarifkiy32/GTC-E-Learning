          ...
          foreach ($course as $c) { ?>
            ...
            if($cekpre == 0){ ?>
              <div class="alert alert-success alert-dismissible">
                ...
                <a class="main-button icon-button" href="<?php echo base_url('homepage/quizoverview/pre/'.$c->slug ) ?>" style="width: 150px">Pre-test</a>
              </div>
              <?php }else{ ?>
                  ...
                  <div class="tabcontent fade in" id="materi<?php echo $num.'b'; ?>">
                    <div class="embed-responsive embed-responsive-16by9" style="width: 100%;height: 100%">
                      ...
                      <!-- <iframe src="<?php echo base_url('assets/pdfjs/web/viewer.html?file=').base_url('assets/modul_pdf/'.$c->pdf)?>" allowfullscreen></iframe> -->
                        <iframe src="<?php echo base_url('assets/modul_pdf/'.$c->pdf)?>?#toolbar=0" allowFullScreen></iframe>
                      </div>
                    </div>
                  </div>
                  <br><br>
