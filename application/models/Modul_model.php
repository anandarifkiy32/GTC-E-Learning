...
class Modul_model extends CI_Model
{
	...
	function selectcourse($where){
		$this->db->select('mdl.nama as namamodul, mtr.judul as materi, mtr.indikator as description, mtr.konten as konten, mtr.id_materi as id_materi, mtr.slug as slug, mtr.pdf as pdf');
